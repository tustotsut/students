...
<body>
    <nav class="navbar  navbar-light justify-content-center fs-2 mb-5" style="background-color: #00FFFF;">
    PHP Completed Crud OPERATION
    </nav>
    <div class="container">
        <div class="text-center mb-4">
            <h3>ADD USER</h3>
            <p class="text-message">Complete the form below to add a new user</p>
            <div class="container d-flex justify-content-center">
                ...
                <div class="row">
                    ...
                    <div class="mb-2 mt-2">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="mail id">
                    </div>
